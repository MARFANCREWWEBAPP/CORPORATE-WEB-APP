...
for(const name of ['store','server','template','workflow-store','reliability','security','mail','import','demo','demo-cleanup','operations','commercial','integrations','postgres','postgres-worker','object-storage'])new vm.Script(fs.readFileSync(path.join(__dirname,'../portal/'+name+'.js'),'utf8'));
